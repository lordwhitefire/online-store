...
export default function SalePage() {
  // Sale products — fetched from the API
  const [saleProducts, setSaleProducts] = useState<any[]>([])
  useState(() => {
    fetch('/api/products').then(r => r.json()).then(d => setSaleProducts(d.slice(0, 8)))
  })
    ...
    <div className="flex min-h-screen flex-col bg-[#141618]">
      ...
      <main className="flex-1">
        ...
        <div className="border-b border-[#33383D] bg-[#1A1C1F] py-6 text-center">
          <h1 className="text-3xl font-bold uppercase text-[#E21818]" style={{ fontFamily: "var(--font-lato)" }}>Sale</h1>
        </div>
          ...
          <div className="flex flex-col gap-6 lg:flex-row">
            ...
            <div className="flex-1 lg:w-[70%]">
              ...
              <div className="mb-4 flex items-center justify-between border border-[#33383D] bg-[#1A1C1F] px-4 py-2">
                ...
                <p className="text-xs text-[#9B9C9E]">Showing all {saleProducts.length} results</p>
              ...
              {/* Product Grid — 3 per row desktop */}
              <div className="grid grid-cols-2 gap-3 md:grid-cols-3">
                {saleProducts.map(p => <ProductCard key={p.slug} product={p} />)}
              </div>
            ...
            <aside className="lg:w-[28%]">
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-1">
                ...
                <div className="bg-[#1A1C1F] p-4">
                  ...
                  <p className="mb-3 text-xs text-[#9B9C9E]">Price: $349 – $951</p>

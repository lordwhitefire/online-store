  ...
  return (
    <div className="flex min-h-screen flex-col bg-[#141618]">
      ...
      <main className="flex-1">
        ...
        {/* Main Content — two column: sidebar + form/map */}
        <div className="mx-auto max-w-7xl px-4 py-8">
          <div className="flex flex-col gap-6 lg:flex-row">
            {/* LEFT: Sidebar — Information + Social */}
            ...
            {/* RIGHT: Contact Info + Form + Map */}
            <div className="flex-1 lg:w-[73%]">
              {/* Contact Info */}
              <div className="mb-6 bg-[#1A1C1F] p-6">
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-xs font-bold text-white">Open Hours</p>
              ...
              <div className="mb-6 bg-[#1A1C1F] p-6">
                ...
                <form className="space-y-4">
                  ...
                  <div>
                    ...
                    <textarea rows={5} className="w-full border border-[#33383D] bg-[#141618] px-3 py-2 text-sm text-white focus:border-[#E21818] focus:outline-none" />
                  </div>
              ...
              {/* Map */}
              <div className="overflow-hidden rounded-lg border border-[#33383D]">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3022.123456789!2d-73.987!3d40.748!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNDDCsDQ0JzUyLjgiTiA3M8KwNTknMTMuMiJX!5e0!3m2!1sen!2suk!4v1234567890"
                  width="100%"
                  height="350"
                  style={{ border: 0 }}
                  allowFullScreen
